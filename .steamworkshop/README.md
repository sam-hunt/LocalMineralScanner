...
`1.6/Languages/`. English is the source of truth; the others are machine-assisted
...
None has been pasted into the Workshop page yet: the page does not exist until
the first release.
